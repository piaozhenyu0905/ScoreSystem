...
import com.system.assessment.constants.BusinessType;
...
public class BusinessTypeHandler implements TypeHandler<String> {

    @Override
    public void setParameter(PreparedStatement ps, int i, String parameter, JdbcType jdbcType) throws SQLException {

        int code = BusinessType.getCodeByDescription(parameter);
        if (code != -1) {
            ps.setInt(i, code);
        } else {
    ...
    public String getResult(ResultSet rs, String columnName) throws SQLException {
        ...
        return BusinessType.getDescriptionByCode(code);
    }
